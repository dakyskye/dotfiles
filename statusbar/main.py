...
from modules import module, date, temperature, usage, volume, github, webcam, layout, dnd
...
def update_bar():
    ...
    for module in modules:
        ...
        if module.next_update_time == None or datetime.now() < cast(datetime, module.next_update_time):
            val = module.get()
        else:
            val = module.update()
